...
public class ParentMailDetailedActivity extends BaseFragmentActivity implements View.OnClickListener {
    public static final String TAG = com.sandeepani.view.Parent.ParentWriteMailToTeacher.class.getSimpleName();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.reply_imgview:
                Intent intent = new Intent(ParentMailDetailedActivity.this, com.sandeepani.view.Parent.ParentWriteMailToTeacher.class);
                Bundle b = new Bundle();
